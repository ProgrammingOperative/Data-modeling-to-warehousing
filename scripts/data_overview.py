...
class Overview:
    ...
    def missing_values_table(self):
        ...
        total_missing_percentage = 100 * self.df.isnull().sum().sum()/ np.round(np.product(self.df.shape), 2)#Total cells
        ...
        print ("Your selected dataframe has " + str(self.df.shape[1]) + " columns.\n"      
            ...
            "Percentage of the total missing values in the dataset is" + str(total_missing_percentage)+ "%")
